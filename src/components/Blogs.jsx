...
const Blogs = ({blog, isSelectPressed, selectedIds, toggleSelect}) => {
    ...
    return (
        ...
        <Link to={`/blog-details/${blog?._id}` }>
            <div className={`${isDarkModeActive ? "border-[#242535] hover:bg-gray-800" : "border-[#E8E8EA] hover:bg-blue-100"} md:w-[392px] hover:scale-110 transition-all duration-500 w-[310px] md:h-[476px] h-[380px] flex shadow-lg shadow-black/50 flex-col gap-4 justify-center border lg:mx-0 mx-auto items-center rounded-xl relative`}>
